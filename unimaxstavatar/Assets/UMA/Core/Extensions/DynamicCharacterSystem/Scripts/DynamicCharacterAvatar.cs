...
namespace UMA.CharacterSystem
{
    ...
    public class DynamicCharacterAvatar : UMAAvatarBase
    {
        ...
        {
            get { return defaultTextRecipe; }
            set { defaultTextRecipe = value; }
        }
        ...
        public string MaxstDoSave(bool saveAsAsset = false, SaveOptions customSaveOptions = SaveOptions.useDefaults)
        {
            ...
            //PlayerPrefs.SetString(PREFS_MAXST_AVATAR_KEY, asset.recipeString);
            ...
            return asset.recipeString;
        }

        public bool IsAvatarSaveData()
        {
            return !loadRecipeString.IsNullOrEmpty();
        }

        // MAXST CUSTOM
        public void MaxstDoLoad()
        {
            Debug.Log($"[MAXST CUSTOM][DynamicCharacterAvatar] MaxstDoLoad recipeString : {loadRecipeString}");
            LoadFromRecipeString(loadRecipeString);
        }
