...
namespace UnityEngine.UI.Extensions
{
	...
	public class FlowLayoutGroup : LayoutGroup
	{
		...
		/// </summary>
		protected readonly IList<RectTransform> _itemList = new List<RectTransform>(); 
		...
		protected virtual float SetLayout(int axis, bool layoutInput)
		{
		...
		protected virtual float CalculateRowVerticalOffset(float groupHeight, float yOffset, float currentRowHeight)
		{
			if (IsLowerAlign) {
		...
		protected virtual float CalculateColHorizontalOffset(float groupWidth, float xOffset, float currentColWidth)
		{
			if (IsRightAlign) {
